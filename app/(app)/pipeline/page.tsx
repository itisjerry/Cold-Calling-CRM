  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Drag leads across stages. Moving to <span className="font-medium">Won</span> creates a project.</p>
      </div>
              ...
              {byStage[stg.id].map((l) => (
                ...
                >
                  <Link href={`/leads/${l.id}`} className="block">
                    ...
                    <div className="text-xs text-muted-foreground flex items-center gap-1 mt-0.5"><Building className="h-3 w-3" />{l.company}</div>
